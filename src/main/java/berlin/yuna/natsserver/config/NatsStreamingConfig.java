...
public enum NatsStreamingConfig {
    ...
    NATS_SERVER(null, "[STRING] Connect to this external NATS Server URL (default otherwise)"),
    ...
    NATS_STREAMING_VERSION("v0.25.2", "[STRING] Overwrites Nats server version on path"),
